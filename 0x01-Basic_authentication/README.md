...
* A documentation is not a simple word, it’s a real sentence explaiining what’s the purpose of the module, class or method (the length of it will be verified)
